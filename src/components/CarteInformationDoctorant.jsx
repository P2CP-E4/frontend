        ...
        <>
            ...
            >
                ...
                <div className='flex flex-col'>
                    ...
                    <span className='py-1 pr-0 ml-2 text-lg font-semibold text-black'>{data?.nomComplet || '///'}</span>
                    <span className="text-[#00337C] font-thin text-lg py-1 ml-1 pr-0">Date de naissance :</span>
                    <span className='py-1 ml-2 text-lg font-semibold text-black '>{data?.dateNaissance.slice(0, 10).replaceAll('-', '/') || '///'}</span>
                    ...
                    <span className='py-1 ml-2 text-lg font-semibold text-black '>{data?.telephone || '///'}</span>
                    <span className="text-[#00337C] font-thin text-lg py-1 ml-1">Email :</span>
                    <span className='py-1 ml-2 text-lg font-semibold text-black '>{data?.email || '///'}</span>
                    <span className="font-semibold text-[#03C988] pt-5 text-lg py-1 pr-0">Status :</span>
                    <span className='py-1 ml-1 text-lg font-semibold text-black'>{data?.status || '///'}</span>
                </div>
                ...
                <div className='flex flex-col'>
                    ...
                    <span className='py-1 ml-2 text-lg font-semibold text-black'>{data?.typeDoctorat || '///'}</span>
                    <span className="text-[#00337C] font-thin text-lg py-1 ml-1">Type du diplome :</span>
                    <span className='py-1 ml-2 text-lg font-semibold text-black'>{data?.typeDiplome || '///'}</span>
                    <span className="text-[#00337C] font-thin text-lg py-1 ml-1">Option :</span>
                    <span className='py-1 ml-2 text-lg font-semibold text-black'>{data?.option || '///'}</span>
                    <div>
                        <div className="text-[#00337C] font-thin text-lg py-1 ml-1">Nom d'Etablissement d'origine :</div>
                        <div className='py-1 ml-2 text-lg font-semibold text-black'>{data?.etablissementOrigine || '///'}</div>
                        <div className="text-[#00337C] font-thin text-lg py-1 ml-1 pt-">Observation :</div>
                        <div className='py-1 ml-2 text-lg font-semibold text-black'>{data?.observation || '///'}</div>
                ...
                <div className='flex flex-col'>
                    ...
                    <span className='py-1 ml-2 font-semibold text-black'>{data?.premiereInscription.slice(0, 10).replaceAll('-', '/') || '///'}</span>
                    <span className="text-[#00337C] font-thin text-lg py-1 ml-1">Date enregistrement FCT:<span className='py-1 ml-2 font-semibold text-black'>{data?.FCT?.slice(0, 10).replaceAll('-', '/') || '///'}</span></span>
                    <span className="text-[#00337C] font-thin text-lg py-1 pb-2 ml-1">Durrée doctoral :<span className='py-1 ml-2 font-semibold text-black'>{data.totalinscription || '///'}ans</span></span>
                    <span className="text-[#00337C] font-thin text-lg py-1 pb-2 ml-1">Laboratoire :<span className='py-1 ml-2 font-semibold text-black'>{data.laboratoire || '///'}</span></span>
                    <span className="text-[#00337C] font-thin text-lg py-1 ml-1 pb-2">Url du Procès Verbal : <a className='py-1 ml-2 text-lg font-thin text-[#13005A] underline underline-offset-4' href={data?.pv?.url}>{data?.pv?.code || '///'}</a></span>
                    <span className="text-[#00337C] font-thin text-lg py-1 ml-1">Intitulé de these :<span className='py-1 ml-2 font-semibold text-black'>{data.intituleeThese || '///'}</span></span>
                    <span className="text-[#00337C] flex justify-start font-thin  ml-1 text-lg py-1">Directeur principal:</span>
                    <span className='flex justify-start py-1 ml-2 text-lg font-semibold text-black'>{data?.directeurPrincipal?.nomComplet || '///'}
                        <img
                            src={more_info_icon}
                            alt='edit'
