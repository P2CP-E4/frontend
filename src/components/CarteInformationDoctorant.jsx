        ...
        <>
            ...
            >
                ...
                <div className='flex flex-col'>
                    ...
                    <span className="text-[#00337C] font-thin text-lg py-1 ml-1">Date enregistrement FCT:<span className='py-1 ml-2 font-semibold text-black'>{data.FCT || '///'}</span></span>
                    ...
                    <span className="text-[#00337C] font-thin text-lg py-1 ml-1 pb-2">Url du Procès Verbal : <a className='py-1 ml-2 text-lg font-semibold text-black underline underline-offset-4' href={data?.pv?.url}>{data?.pv?.code || '///'}</a></span>
