...
const StatusCustomCard = ({ value }) => {
    switch (value) {
        ...
        case 'Abandon':
            return <span className='bg-[#FFA07A80] text-[#AA4117] text-center px-6 py-0.5 rounded-lg'>{value}</span>
        case 'En attente':
            return <span className='bg-[#6FB1FC80] text-[#1858A1] text-center px-5 py-0.5 rounded-lg'>{value}</span>
        case 'Différé':
